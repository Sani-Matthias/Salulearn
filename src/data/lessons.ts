  ...
  lessons: [
    {
      ...
      steps: [
        ...
        { type: 'text', emoji: '🇪🇺', title: 'Die Notrufnummer 112', content: 'Die Nummer 112 gilt in ganz Europa – kostenlos, 24 Stunden am Tag, 7 Tage die Woche. In Deutschland gilt zusätzlich die 110 für die Polizei. Aber 112 funktioniert immer!', style: 'info' },
        { type: 'multiple-choice', question: 'Welche Notrufnummer gilt in ganz Europa?', options: ['110', '911', '112', '999'], correctIndex: 2, explanation: '112 ist die europaweite Notrufnummer – kostenlos von jedem Telefon erreichbar.' },
    ...
    },
    {
      ...
      steps: [
        ...
        { type: 'multiple-choice', question: 'Wie weit vor dem Unfallort stellst du auf der Autobahn das Warndreieck auf?', options: ['15 Meter', '25 Meter', '50 Meter', '100 Meter'], correctIndex: 2, explanation: 'Auf der Autobahn 100 m Abstand. Auf Landstraßen 50-100 m, innerorts 50 m.' },
    ...
    },
    {
      ...
      steps: [
        ...
        { type: 'text', emoji: '🔤', title: 'Das DRÄB-Schema', content: '🅳 – DANGER (Gefahr beseitigen)\n🆁 – RESPONSE (Reaktion prüfen)\n🅰 – AIRWAY (Atemwege öffnen)\n🅱 – BREATHING (Atmung prüfen)\n\nDieses Schema hilft dir, systematisch vorzugehen!', style: 'default' },
  ...
  lessons: [
    ...
    },
    {
      ...
      steps: [
        ...
        { type: 'text', emoji: '🔢', title: 'Der 30:2 Rhythmus', content: '30 Kompressionen → 2 Beatmungen → 30 Kompressionen → ...\n\nOhne Beatmung-Training:\nNur Kompressionen kontinuierlich – das ist auch wirksam!\n\nWichtig: Nicht unterbrechen – max. 10 Sekunden Pause.', style: 'default' },
