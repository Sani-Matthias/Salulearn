  ...
  lessons: [
    ...
    },
    {
      ...
      steps: [
        ...
        { type: 'ordering', question: 'In welcher Reihenfolge verwendest du den AED?', items: ['Pads aufkleben', 'AED einschalten (Deckel öffnen)', 'Schock abgeben', 'Einweisung beachten', 'Abstand zum Patienten halten'], correctOrder: [1, 3, 0, 4, 2], explanation: 'Zuerst einschalten, dann die Anweisungen des AED beachten, Pads aufkleben, Abstand zum Patienten halten und erst dann den Schock auslösen.' },
