  ...
  lessons: [
    {
      id: 'l1',
      title: 'Der Notruf',
      subtitle: '144 – Die Lebensretter-Nummer',
      emoji: '📞',
      color: '#FF4B4B',
      xpReward: 20,
      estimatedMin: 3,
      steps: [
        ...
        { type: 'text', emoji: '🇦🇹', title: 'Die Notrufnummern in Österreich', content: '144 – Rettung\n122 – Feuerwehr\n133 – Polizei\n112 – Europäischer Notruf (gilt EU-weit)\n\nAlle Nummern sind kostenlos, 24 Stunden am Tag erreichbar. In Österreich ist 144 die wichtigste Nummer für medizinische Notfälle!', style: 'info' },
        { type: 'multiple-choice', question: 'Welche Notrufnummer rufst du in Österreich bei einem medizinischen Notfall?', options: ['133', '122', '144', '911'], correctIndex: 2, explanation: '144 ist die österreichische Notrufnummer für die Rettung. Der Euronotruf 112 funktioniert in Österreich auch – er landet aber bei der Polizei, welche dann die Rettung alarmiert. Bei medizinischen Notfällen wählst du daher am besten direkt 144.' },
    ...
    },
    {
      ...
      steps: [
        ...
        { type: 'text', emoji: '🦺', title: 'Eigenschutz geht vor!', content: 'Bevor du hilfst, muss die Unfallstelle sicher sein.\n\nBei einem Autounfall in Österreich gilt: \n1. Rettungsgasse bilden! Ohne diese, kommt die Hilfe nicht dort an, wo diese gebraucht wird. \n2. Stelle dein Auto sicher an der Unfallstelle ab. \n3. Warnblinkanlage einschalten.\n4. Vor dem Aussteigen Warnweste anlegen.\n5. Warndreieck aufstellen.\n6. Hilfe leisten', style: 'warning' },
        ...
        { type: 'multiple-choice', question: 'Warum parkst du dein Auto zwischen der Unfallstelle und dem Warndreieck?', options: ['Es sieht ordentlicher aus', 'Damit du besser sehen kannst', 'Um das eigene Fahrzeug zu sichern, und einen Pufferschutz für die Verletzten zu schaffen', 'Das ist egal'], correctIndex: 2, explanation: 'Dein Fahrzeug bildet einen Schutzpuffer zwischen fließendem Verkehr und der Unfallstelle.' },
        { type: 'complete', xpEarned: 20 },
      ],
    },
    {
      ...
      steps: [
        ...
        { type: 'text', emoji: '🔤', title: 'Der Notfallcheck (Österreich)', content: 'In Österreich lernst du beim Roten Kreuz den Notfallcheck:\n\n1. Bewusstsein prüfen – laut ansprechen & sanft an den Schultern rütteln\n2. Hilferuf – laut um Hilfe rufen, jemanden zum Notruf 144 schicken\n3. Atemwege freimachen – Kopf vorsichtig überstrecken, Kinn anheben\n4. Atemkontrolle – max. 10 Sek.: sehen, hören, fühlen – atmet die Person normal?\n\nDas Ergebnis entscheidet, was als Nächstes zu tun ist (stabile Seitenlage oder Wiederbelebung).', style: 'default' },
        { type: 'multiple-choice', question: 'Was ist beim Notfallcheck der dritte Schritt?', options: ['Den Puls am Handgelenk messen', 'Atemwege freimachen (Kopf überstrecken, Kinn anheben)', 'Sofort mit der Herzdruckmassage beginnen', 'Die Person zudecken'], correctIndex: 1, explanation: 'Nach Bewusstsein prüfen und Hilferuf machst du die Atemwege frei: Kopf überstrecken, Kinn anheben – sonst kann die zurückgesunkene Zunge die Atmung blockieren.' },
        { type: 'true-false', statement: 'Wenn jemand auf Ansprechen nicht reagiert, ist das sofort ein Notfall.', correct: true, explanation: 'Richtig! Keine Reaktion = Bewusstlosigkeit = Notruf 144 sofort absetzen!' },
        { type: 'ordering', question: 'Bringe den Notfallcheck in die richtige Reihenfolge:', items: ['Atemwege freimachen (Kopf überstrecken)', 'Bewusstsein prüfen (ansprechen, rütteln)', 'Atemkontrolle (sehen, hören, fühlen)', 'Hilferuf (laut um Hilfe rufen)'], correctOrder: [1, 3, 0, 2], explanation: 'Notfallcheck: Bewusstsein prüfen → Hilferuf → Atemwege freimachen → Atemkontrolle. Diese Reihenfolge ist entscheidend!' },
        { type: 'complete', xpEarned: 20 },
      ],
    },
  ],
  ...
  lessons: [
    {
      ...
      steps: [
        ...
        { type: 'true-false', statement: 'Schnappatmung ist eine normale Form der Atmung und kein Notfallzeichen.', correct: false, explanation: 'Falsch! Schnappatmung ist ein Zeichen des Herzstillstands. Sofort mit CPR beginnen und 144 anrufen!' },
        { type: 'multiple-choice', question: 'Was machst du als Erstes bei einer bewusstlosen Person ohne Atmung?', options: ['Ruhig abwarten und beobachten', '144 anrufen und sofort CPR beginnen', 'Essen und Trinken geben', 'Auf die Seite drehen'], correctIndex: 1, explanation: '144 anrufen (oder jemanden schicken) und sofort CPR starten. Jede Sekunde zählt!' },
    ...
    },
    {
      ...
      steps: [
        ...
        { type: 'text', emoji: '🔢', title: 'Der 30:2 Rhythmus (ERC 2025)', content: '30 Kompressionen → 2 Beatmungen → 30 Kompressionen → ...\n\nFür Laien ohne Beatmungs-Training:\nNur Kompressionen kontinuierlich – das ist laut ERC 2025 auch bei Erwachsenen wirksam!\n\nWichtig: Nicht unterbrechen – max. 10 Sekunden Pause.\n\nBei Kindern (1 Jahr bis Pubertät): Laien führen ebenfalls 30:2 durch. Wer in Kinder-Wiederbelebung geschult ist, beginnt mit 5 Beatmungen und nutzt dann 15:2.', style: 'default' },
        ...
        { type: 'multiple-choice', question: 'Was ist der korrekte CPR-Rhythmus für Erwachsene?', options: ['15 Kompressionen : 1 Beatmung', '15 Kompressionen : 2 Beatmungen', '30 Kompressionen : 1 Beatmung', '30 Kompressionen : 2 Beatmungen'], correctIndex: 3, explanation: '30:2 ist der Standardrhythmus für Erwachsene – und für Laien auch bei Kindern. Nur speziell geschulte Helfer verwenden bei Kindern 15:2 (mit 5 initialen Beatmungen).' },
    ...
    },
    {
      ...
      steps: [
        ...
        { type: 'ordering', question: 'In welcher Reihenfolge verwendest du den AED?', items: ['Pads aufkleben', 'AED einschalten (Deckel öffnen)', 'Schock abgeben', 'Anweisung beachten', 'Abstand zum Patienten halten'], correctOrder: [1, 3, 0, 4, 2], explanation: 'Zuerst einschalten, dann die Anweisungen des AED beachten, Pads aufkleben, Abstand zum Patienten halten und erst dann den Schock auslösen.' },
  ...
  lessons: [
    {
      ...
      steps: [
        ...
        { type: 'true-false', statement: 'Eine Verbrennung 3. Grades ist oft schmerzlos, weil die Nerven zerstört sind.', correct: true, explanation: 'Richtig! Kein Schmerz bedeutet hier = sehr schwere Verbrennung. Sofort 144 anrufen!' },
        { type: 'complete', xpEarned: 20 },
      ],
    },
    {
  ...
  lessons: [
    {
      ...
      steps: [
        ...
        { type: 'true-false', statement: 'Bei einem anaphylaktischen Schock solltest du zuerst warten, ob die Symptome von selbst besser werden.', correct: false, explanation: 'NIEMALS warten! Sofort 144 und EpiPen anwenden. Anaphylaxie kann in Minuten tödlich sein.' },
        { type: 'complete', xpEarned: 25 },
      ],
    },
    {
  ...
  lessons: [
    ...
    },
    {
      ...
      steps: [
        ...
        { type: 'multiple-choice', question: 'Dein Freund lächelt schief und ein Mundwinkel hängt herunter. Was tust du?', options: ['Er macht einen Witz', 'Verdacht auf Schlaganfall – FAST-Test durchführen!', 'Wahrscheinlich ein Zahnproblem', 'Nicht schlimm, beobachten'], correctIndex: 1, explanation: 'Gesichtshälfte hängt = klassisches Schlaganfall-Zeichen (F in FAST). Sofort weitertesten und ggf. 144!' },
        { type: 'ordering', question: 'Führe den FAST-Test in der richtigen Reihenfolge durch:', items: ['SPEECH – Sprechen/Nuscheln prüfen', 'TIME – Sofort 144 anrufen', 'FACE – Gesicht prüfen (Lächeln lassen)', 'ARMS – Arme heben lassen'], correctOrder: [2, 3, 0, 1], explanation: 'F-A-S-T: Face → Arms → Speech → Time (144!). Wenn auch nur ein Test positiv: Schlaganfall-Verdacht!' },
        { type: 'true-false', statement: 'Nur wenn ALLE FAST-Tests positiv sind, rufst du 144 an.', correct: false, explanation: 'Falsch! SCHON EIN positiver Test reicht aus für den Notruf. Im Zweifel anrufen!' },
        { type: 'complete', xpEarned: 20 },
      ],
    },
  ],
